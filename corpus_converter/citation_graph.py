...
def build_citation_graph(
    ...
    lines = [
        "# Corpus Paper Graph",
        "",
        "This corpus-local graph combines extracted citations with explainable related-paper similarity. It does not query or reproduce Connected Papers or Litmaps.",
        "",
        "## Summary",
        "",
        f"- Works: {len(works)}",
